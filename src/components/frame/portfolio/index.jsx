	...
	const array = [
		{
			...
			isProgress: 0,
			title: 'Aidan\'s',
			description: '- A responsive Single Page Application(SPA) using React\n- A simple web application for introducing myself',
		...
		},
		{
			...
			isProgress: 0,
			title: '#Camagru',
			description: '- A responsive Single Page Application(SPA) using React & Java\n- A Social Network Service(SNS) for sharing pictures like Instagram',
		...
		},
		{
			...
			isProgress: 1,
			title: 'M@TCH@',
			description: '- A responsive Single Page Application(SPA) using React & Node\n- A Social Network Service(SNS) for matching dating partner like Tinder',
